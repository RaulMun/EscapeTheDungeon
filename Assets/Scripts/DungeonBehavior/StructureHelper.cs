...
public static class StructureHelper
{
    ...
    public static Vector2Int GenerateBottomLeftCornerBetween(
        Vector2Int boundaryLeftPoint, Vector2Int boundaryRightPoint, float pointModifier, int offset) //Can change the offset to 0 to have the walls dividing the rooms instead of a corridor
    {
